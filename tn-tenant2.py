...
vnsRsAbsConnectionConns = cobra.model.vns.RsAbsConnectionConns(vnsAbsConnection, tDn=u'uni/tn-tenant2/AbsGraph-SG_ASAv_Template/AbsNode-Firewall/AbsFConn-external')
vnsRsAbsConnectionConns2 = cobra.model.vns.RsAbsConnectionConns(vnsAbsConnection, tDn=u'uni/tn-tenant2/AbsGraph-SG_ASAv_Template/AbsTermNodeCon-T1/AbsTConn')
...
vnsRsAbsConnectionConns3 = cobra.model.vns.RsAbsConnectionConns(vnsAbsConnection2, tDn=u'uni/tn-tenant2/AbsGraph-SG_ASAv_Template/AbsTermNodeProv-T2/AbsTConn')
vnsRsAbsConnectionConns4 = cobra.model.vns.RsAbsConnectionConns(vnsAbsConnection2, tDn=u'uni/tn-tenant2/AbsGraph-SG_ASAv_Template/AbsNode-Firewall/AbsFConn-internal')
...
drawInst = cobra.model.draw.Inst(drawCont, info=u"{'epg-Ext_L3_OSPF-extInst-cloud':{'x':700,'y':60},'epg-EPG-2-undefined':{'x':428,'y':355},'ctrct_provider-Con_RDP-undefined':{'x':654,'y':487},'ctrct_provider-Con_ICMP-undefined':{'x':525,'y':482},'epg-EPG-1-undefined':{'x':818,'y':353}}", oDn=u'uni/tn-tenant2/ap-test-application1')
...
vnsRsCIfAttN = cobra.model.vns.RsCIfAttN(vnsLIf, tDn=u'uni/tn-tenant2/lDevVip-ASAv/cDev-ASAv_Device_1/cIf-[Management0/0]')
...
vnsRsCIfAttN2 = cobra.model.vns.RsCIfAttN(vnsLIf2, tDn=u'uni/tn-tenant2/lDevVip-ASAv/cDev-ASAv_Device_1/cIf-[GigabitEthernet0/1]')
...
vnsRsCIfAttN3 = cobra.model.vns.RsCIfAttN(vnsLIf3, tDn=u'uni/tn-tenant2/lDevVip-ASAv/cDev-ASAv_Device_1/cIf-[GigabitEthernet0/0]')
