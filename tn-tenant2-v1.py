...
fvSubnet = cobra.model.fv.Subnet(fvBD, name=u'', descr=u'', ctrl=u'', ip=u'10.54.62.145/29', preferred=u'no')
...
fvSubnet2 = cobra.model.fv.Subnet(fvBD3, name=u'', descr=u'', ctrl=u'querier', ip=u'10.54.62.153/29', preferred=u'no')
